...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	if (!m_Model->Initialize(m_Direct3D->GetDevice(), (WCHAR*)L"../proj/data/seafloor.dds", (char*)"../proj/data/sphere.txt"))
	{
...
bool GraphicsClass::Render()
{
	...
	for (int index = 0; index < modelCount; index++)
	{
		...
		if (m_Frustum->CheckSphere(positionX, positionY, positionZ, radius))
		{
			...
			m_LightShader->Render(m_Direct3D->GetDeviceContext(), m_Model->GetIndexCount(), worldMatrix, viewMatrix, projectionMatrix, m_Model->GetTexture(), m_Light->GetDirection(), color);
