...
bool TextureShaderClass::FontInitialize(ID3D11Device* device, HWND hwnd)
{
	// 정점 및 픽셀 쉐이더를 초기화합니다.
	return FontInitializeShader(device, hwnd, (WCHAR*)L"../proj/Font.vs", (WCHAR*)L"../proj/Font.ps");
}


bool TextureShaderClass::TextureInitialize(ID3D11Device* device, HWND hwnd)
{
	// 정점 및 픽셀 쉐이더를 초기화합니다.
	return TextureInitializeShader(device, hwnd, (WCHAR*)L"../proj/texture.vs", (WCHAR*)L"../proj/texture.ps");
}
...
bool TextureShaderClass::FontRender(ID3D11DeviceContext* deviceContext, int indexCount, XMMATRIX worldMatrix, XMMATRIX viewMatrix,
...
bool TextureShaderClass::FontInitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
...
bool TextureShaderClass::TextureInitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
	ID3D10Blob* errorMessage = nullptr;
