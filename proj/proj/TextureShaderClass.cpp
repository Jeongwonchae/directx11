...
{
	//정점 및 픽셀 쉐이더를 초기화
	WCHAR* vsFilename = new WCHAR[sizeof("../proj/Texture.vs")];
	WCHAR* psFilename = new WCHAR[sizeof("../proj/Texture.ps")];
	wcscpy(vsFilename, L"../proj/Texture.vs");
	wcscpy(psFilename, L"../proj/Texture.ps");
